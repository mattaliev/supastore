...
export default function TermsOfService() {
  ...
  const businessName = "PT PMA ALIEN UNDERGROUND ORGANISATION";
  ...
  return (
    <div id="terms">
      <h1 className="font-bold text-base">OVERVIEW</h1>
      <br />
      This website is operated by {businessName}. Throughout the site, the terms
      “we”, “us” and “our” refer to {businessName}. {businessName} offers this
      ...
      <br />
      <br />
      Our store is hosted independently from Telegram. They provide us with the
      ability for customers to access our platform.
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 1 - ONLINE STORE TERMS</h1>
      <br />
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 2 - GENERAL CONDITIONS</h1>
      <br />
      ...
      content thereof) without notice at any time. <br /> We shall not be liable
      to you or to any third-party for any modification, price change,
      suspension or discontinuance of the Service.
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 5 - PRODUCTS OR SERVICES</h1>
      <br />
      ...
      Service made on this site is void where prohibited. We do not warrant that
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 7 - OPTIONAL TOOLS</h1>
      <br />
      ...
      tools.
      <br />
      Any use by you of the optional tools offered through the site is entirely
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 8 - THIRD-PARTY LINKS</h1>
      <br />
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 10 - PERSONAL INFORMATION</h1>
      <br />
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 12 - PROHIBITED USES</h1>
      <br />
      ...
      non-infringement.
      <br />
      In no case shall {businessName}, our directors, officers, employees,
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 14 - INDEMNIFICATION</h1>
      <br />
      You agree to indemnify, defend and hold harmless {businessName} and our
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 15 - SEVERABILITY</h1>
      <br />
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 16 - TERMINATION</h1>
      <br />
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 17 - ENTIRE AGREEMENT</h1>
      <br />
      ...
      and understanding between you and us and governs your use of the Service,
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 18 - GOVERNING LAW</h1>
      <br />
      ...
      <br />
      <br />
      <h1 className="font-bold text-base">SECTION 20 - CONTACT INFORMATION</h1>
      <br />
      Questions about the Terms of Service should be sent to us on Telegram
      through our{" "}
