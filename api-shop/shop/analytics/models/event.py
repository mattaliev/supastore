...
class Event(BaseEntity):
    ...
    @staticmethod
    def register_page_view(*, user: TelegramUser, page: str):
    ...
    @staticmethod
    def register_user_register(*, user: TelegramUser):
        Event.objects.create(
    ...
    @staticmethod
    def register_user_visited(*, user: TelegramUser):
        Event.objects.create(
    ...
    @staticmethod
    def register_added_to_cart(*, cart: Cart, cart_item: CartItem):
        Event.objects.create(
    ...
    @staticmethod
    def register_removed_from_cart(*, cart: Cart, product: Product):
        Event.objects.create(
    ...
    @staticmethod
    def register_checkout_started(*, order: Order):
        Event.objects.create(
    ...
    @staticmethod
    def register_payment_started(*, payment: Payment):
        Event.objects.create(
    ...
    @staticmethod
    def register_payment_completed(*, payment: Payment):
        Event.objects.create(
